...
var AnimatedBarChart =
/*#__PURE__*/
function (_AnimatedRectangleCha) {
  ...
  function AnimatedBarChart(data) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AnimatedBarChart).call(this, data, config));
...
function (_AnimatedRectangleCha) {
  ...
  function AnimatedColumnChart(data) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AnimatedColumnChart).call(this, data, config)); // Create chart scales
